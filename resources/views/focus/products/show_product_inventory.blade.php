...
@section('title', 'All Stock Movement Report')

@section('content')
<div class="content-wrapper">
    <div class="content-header row mb-1">
        <div class="content-header-left col-6">
            <h4 class="content-header-title">All Stock Movement Report</h4>
        </div>
        <div class="col-6">
    ...
    const Index = {
        ...
        drawDataTable(params = {}) {
            $('#stock-issue-tbl').dataTable({
                ...
                ajax: {
                    url: "{{ route('biller.products.get_all_products') }}",
                    type: 'POST',
                    data: {
                ...
                ...['name','unit','code','opening_balance', 'grn_qty','issue_qty', 'return_qty','stock_adj_qty','qty', 'warehouse'].map(v => ({data: v, name: v}))
                ],
                order: [[0, "desc"]],
                searchDelay: 500,
                dom: 'Blfrtip',
