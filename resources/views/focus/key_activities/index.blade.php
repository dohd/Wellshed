...
@section ('title', 'Key Activities Management')

@section('page-header')
    <h1>{{ 'Key Activities Management' }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ 'Key Activities Management' }}</h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#key_activities-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.key_activities.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#key_activities-table_wrapper').removeClass('form-inline');
