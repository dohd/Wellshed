...
@section ('title', 'Job Title Management' . ' | ' . 'Edit')
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($jobtitles, ['route' => ['biller.jobtitles.update', $jobtitles], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-department']) }}
