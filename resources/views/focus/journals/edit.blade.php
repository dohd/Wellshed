...
@section('title', 'Edit | Manual Journals')

@section('content')
<div class="content-wrapper">
    <div class="content-header row mb-1">
        <div class="content-header-left col-6">
            <h4 class="content-header-title">Edit Journal Entry</h4>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body ">
                            {{ Form::model($journal, ['route' => array('biller.journals.update', $journal), 'method' => 'PATCH']) }}
