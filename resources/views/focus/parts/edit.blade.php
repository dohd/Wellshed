        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Edit Parts</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($part, ['route' => ['biller.parts.update', $part], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-department']) }}
...
<script type="text/javascript">
    ...
    const Form = {
        ...
        init() {
            ...
            $("#productRow").remove();
            let rowId = $("#partsTbl tbody tr").length;
        ...
        onQtyChange(){
            ...
            const total_qty = accounting.unformat($('#total').val());
            let row_qty = accounting.unformat(row.find('.qty_for_single').val());
        ...
        calculateQty(){
            const totalQty = accounting.unformat($('#total').val());
            $("#partsTbl tbody tr").each(function(i) {
                const qty = accounting.unformat($(this).find('.qty_for_single').val());
                let quantity = qty*totalQty;
                console.log(quantity,totalQty, qty);
        ...
        stockRow(){
            return `
                 <tr id="productRow">
                    ...
                    <td><input type="text" name="qty_for_single[]" id="qty_for_single-p0" value="1" class="form-control qty_for_single"></td>
        ...
        productRow(v,i){
            return `
                <tr>
                    ...
                    <td><input type="text" name="qty[]" id="qty-p0" value="${v.qty}" class="form-control qty"></td>
                    <td><button type="button" class="btn btn-danger delete"><i class="fa fa-minus-square" aria-hidden="true"></i></button></td>
