<h5><b>Cleared Transactions After {{ dateFormat($model->ending_period) }} (<span id="cleared-tr-after-ep">0</span>)</b></h5>
<div class="table-responsive mb-1" style="max-height: 60vh">        
    <table id="cleared-tr-after-ep-tbl" class="table text-center">
        <thead>
        ...
        <tfoot>
            <tr>
                <th><h5 class="font-weight-bold">Total: <span id="cleared-tr-after-ep-total">0.00</span></h5></th>
                <th colspan="4"></th>
                <th><h5 class="font-weight-bold cleared-tr-after-ep-dtotal">0.00</h5></th>
                <th><h5 class="font-weight-bold cleared-tr-after-ep-ctotal">0.00</h5></th>
            </tr>
        </tfoot>
    </table>
</div>
