                ...
                <div class="row">
                    <div class="col-9 pt-1">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <input type="text" id="start_date" class="d-inline col-4 mr-1 form-control datepicker start_date" style="height: 30px;" placeholder="{{ date('d-m-Y') }}">
            ...
            <div class="col-8 col-xs-12 ml-auto mr-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-footer pt-0">
                        <table class="table table-sm mb-0 h5">
                            <tbody>
                                <tr>
                                    @php $cogSum = $accountTypeDetails->where('system_rel', 'cogs')->sum('balance') @endphp
                                    <td class="font-weight-bold">Total Cost of Sales</td>
                ...
                <div class="card">
                    ...
                    <div class="card-footer pt-0">
                        <table class="table table-sm mb-0 h5">
                            <tbody>
                                <tr>
                                    @php $expenseSum = $accountTypeDetails->where('system_rel', 'expense')->sum('balance') @endphp
                                    <td class="font-weight-bold">Total Expenses</td>
                                    <td class="font-weight-bold">{{ numberFormat($expenseSum) }}</td>
                                </tr>
                            </tbody>
                        </table>  
                    </div>
                ...
                <div class="card">
                    <div class="card-footer pt-0">
                        <table class="table table-sm mb-0 h5">
                            <tbody>
                                @php $netProfit = $grossProfit+$otherIncomeSum-$expenseSum-$otherExpenseSum @endphp
                                <tr>
