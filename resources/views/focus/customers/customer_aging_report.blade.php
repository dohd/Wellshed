...
@section ('title', 'Customer Aging Summary')

@section('content')
<div class="content-wrapper">
    <div class="content-header row mb-1">
        <div class="content-header-left col-6">
            <h4 class="content-header-title">Customer Aging Summary</h4>
        </div>
                            ...
                            <table id="agingTbl" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($customers_data as $data)
                                        ...
                                        @endphp
                                        <tr>
                                            <td><a href="{{ route('biller.customers.show', $customer) }}">{{ $customer->company ?: $customer->name }}</a></td>
...
<script>
    ...
    const Form = {
        ...
        searchClick(){
            ...
            $.get("{{route('biller.customers.get_aging_report')}}", {
            ...
            .then(response => {
                ...
                response.customers_data.forEach(function(data) {
                    let row = `<tr><td>${data.customer}</td>`;
