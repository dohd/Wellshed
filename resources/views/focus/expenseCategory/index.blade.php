                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <table id="ecTable" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Description</th>
...
<script>
    ...
    function draw_data() {
        ...
        var dataTable = $('#ecTable').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            language: tableLan,
            ajax: {
                url: '{{ route("biller.expense-category.index") }}',
                type: 'GET',
                data: {
