		...
		<tr>
			<td class="doc-title-td">
				<span class='doc-title'>
					<b>Technician's Installation List</b>
				</span>				
			</td>
		</tr>
	</table><br>
	<table class="customer-dt" cellpadding="10">
		<tr>
			<td width="50%">
				...
				@php
					$clientname = $resource->lead ? $resource->lead->client_name : '';
					$branch = 'Head Office';
					$address = $resource->lead ? $resource->lead->client_address : '';
					$email = $resource->lead ? $resource->lead->client_email : '';
					$cell = $resource->lead ? $resource->lead->client_contact : '';
					if ($resource->client) {
