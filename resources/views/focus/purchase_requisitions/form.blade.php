<div class="form-group row">
    ...
    <div class="col-4">
        ...
        {{ Form::hidden('employee_id', @$purchase_request->employee_id) }}
    </div>
    ...
    <div class="col-2">
        ...
        {{ Form::hidden('priority', @$purchase_request->priority) }}
    </div>   

    <div class="col-2">
        <label for="expect_date">Expected Delivery Date</label>
        {{ Form::text('expect_date', null, ['class' => 'form-control datepicker', 'id' => 'expect_date','required']) }}
    </div>    
</div>
...
<div class="form-group row">
    <div class="col-4">
        ...
        {{ Form::text('note', @$purchase_request->note, ['class' => 'form-control', 'id' => 'note', 'readonly']) }}
    </div>
    <div class="col-2">
        ...
        {{ Form::hidden('item_type', @$purchase_request->item_type) }}
    </div>
    <div class="col-3 div_project d-none">
        ...
        {{ Form::hidden('project_id', @$purchase_request->project_id) }}
    </div>
    <div class="col-3 div_milestone d-none">
        ...
        {{ Form::hidden('project_milestone_id', @$purchase_request->project_milestone_id) }}
        {{ Form::hidden('purchase_request_id', @$purchase_request->id) }}
        {{ Form::hidden('part_id', @$purchase_request->part_id) }}
    </div>
    <div class="col-4 div_fg_goods d-none">
        <label for="fg_goods">Search Finished Goods</label>
        <select name="part_id" id="fg_goods" class="form-control" data-placeholder="Search Finished Goods" disabled>
...
<div class="form-group row">
    @include('focus.purchase_requisitions.partials.requisition_items')
</div>
<div class="form-group row">
