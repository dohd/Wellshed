...
@section ('title',  "Create Casual Labourers' Remuneration")
...
<div class="content-wrapper">
    <div class="content-header row mb-1">
        ...
        <div class="content-header-left col-6">
            <h3 class="mb-0">Create Casual Labourers' Remuneration</h3>
        </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="edit-form-btn">
                                    ...
                                    {{ Form::submit(trans('buttons.general.crud.create') . ' Remuneration', ['class' => 'btn btn-primary btn-md']) }}
                                </div>  
                                </form> 
                            </div>
                        </div>
