...
@section ('title', 'Target Zones Management')

@section('page-header')
    <h1>Target Zones Management</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Target Zones Management</h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#target_zones-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.target_zones.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#target_zones-table_wrapper').removeClass('form-inline');
