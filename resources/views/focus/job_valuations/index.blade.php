...
@section('title', 'Job Valuations')

@section('content')
<div class="content-wrapper">
    <div class="content-header row mb-1">
        <div class="content-header-left col-6">
            <h4 class="content-header-title">Job Valuations</h4>
        </div>
        <div class="col-6">
    ...
    const Index = {
        ...
        drawDataTable() {
            $('#valuationsTbl').dataTable({
                ...
                ajax: {
                    url: "{{ route('biller.job_valuations.get') }}",
                    type: 'POST',
                    data: {
                ...
                columns: [
                    ...
                    ...['row_check', 'invoice_tid', 'tid', 'quote_tid', 'customer', 'quote_amount', 'subtotal', 'balance', 'date'].map(v => ({data: v, name: v})),
