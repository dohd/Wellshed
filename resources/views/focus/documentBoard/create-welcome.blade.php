                    ...
                    <div class="card" style="border-radius: 8px;">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form action="{{ route('biller.company-notice-board.store-welcome') }}" method="POST">
                                    @csrf
                                    <div class="col-12">
                                        <h4>Draft your company's welcome message</h4>
                                    ...
                                    <div class="col-6 col-lg-4 mt-1">
                                        <button type="submit" class="btn btn-large btn-blue mb-1">
                                            <i class="fa fa-check"></i> Update Welcome Message
                                        </button>
                                    </div>
                                </form>
...
@section('after-scripts')
    ...
    <script>
        ...
        tinymce.init({
            ...
            height: 800,
            images_upload_url: '{{ route("tiny-photo", 'welcome') }}',  // Laravel route for image upload
