...
@section ('title', 'Valuation BoQs')

@section('content')
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h4 class="content-header-title">Valuation BoQs</h4>
        </div>   
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="{{ route('biller.boq_valuations.create') }}">
                                <input type="hidden" name="boq_id" id="quote">
                            </form>  
                        </div>
                    </div>
                </div>
    ...
    const Index = {
        ...
        drawDataTable() {
            $('#quotesTbl').dataTable({
                ...
                ajax: {
                    url: '{{ route("biller.boq_valuations.get_boqs") }}',
                    type: 'POST',
                    data: {
                ...
                columns: [
                    ...
                    ...[
                        'tid', 'customer', 'name', 'subtotal', 'perc_valuated', 'valuated', 'balance', 
                    ].map(v => ({data: v, name: v})),
                ],
                order: [[0, "desc"]],
                searchDelay: 500,
