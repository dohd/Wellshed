    ...
    <div class="table-responsive mb-2 pb-2" style="max-height: 80vh">                            
        <table id="productsTbl" class="table tfr my_stripe_single pb-2 text-center">
            ...
            <tbody>
                ...
                <tr class="product-templ" style="display: none">
                    ...
                    <td><input type="text" class="form-control perc-val" name="perc_valuated[]" required></td>                
                    <td><input type="text" class="form-control amount-val" name="total_valuated[]" required></td>
                    ...
                    <input type="hidden" name="boq_item_id[]" class="boqitem-id">
                </tr>
                <!-- Title Row Template -->
                <tr class="title-templ d-none">
                    <td>@include('focus.job_valuations.partials.macro', ['elem' => 'dropdown'])</td>
                ...
                <tr class="product-templ-add d-none">
                    <td>@include('focus.job_valuations.partials.macro', ['elem' => 'dropdown'])</td>
                ...
                <tr class="title-templ-add d-none">
                    <td>@include('focus.job_valuations.partials.macro', ['elem' => 'dropdown'])</td>
                    <td><input type="text" name="numbering[]" class="form-control num-inp"></td>
