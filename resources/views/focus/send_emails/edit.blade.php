...
@section ('title', 'Edit Send Email')

@section('page-header')
    <h1>
        <small>Edit Send Email</small>
    </h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Edit Send Email</h4>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="media width-250 float-right">
                        ...
                        <div class="media-body media-right text-right">
                            @include('focus.send_emails.partials.send_emails-header-buttons')
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($send_email, ['route' => ['biller.send_emails.update', $send_email], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-department']) }}

                                    <div class="form-group">
                                        {{-- Including Form blade file --}}
                                        @include("focus.send_emails.form")
                                        <div class="edit-form-btn">
                                            {{ link_to_route('biller.send_emails.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
    ...
    const Form = {
        ...
        init(){
            ...
            if(Form.send_email){
                ...
                if (Form.send_email.scheduled_date) $('#schedule_date').val(Form.send_email.scheduled_date);
            }
            var costPer160 = 0.60;
