...
@section ('title',  'Create Employee Appraisal')

@section('content')
<div class="content-wrapper">
    <div class="content-header row mb-1">
        <div class="content-header-left col-6">
            <h3 class="mb-0">Create Employee Appraisal</h3>
        </div>
            ...
            <div class="col-12">
                <div class="card" style="border-radius: 8px;">
                    <div class="card-content">
                        <div class="card-body">
                            {{ Form::open(['route' => 'biller.employee_appraisals.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-employee_appraisals']) }}
                            <div class="form-group">
                                {{-- Including Form blade file --}}
                                @include('focus.employeeAppraisal.form')
                                <div class="edit-form-btn">
{{--                                    {{ link_to_route('biller.employee_appraisals.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}--}}
