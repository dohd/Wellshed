...
@section ('title', 'Edit Employee Appraisal')

@section('content')
<div class="content-wrapper">
    <div class="content-header row mb-1">
        <div class="content-header-left col-6">
            <h3 class="mb-0">Edit Employee Appraisal</h3>
        </div>
            ...
            <div class="col-12">
                <div class="card" style="border-radius: 8px;">
                    <div class="card-content">
                        <div class="card-body">
                            {{ Form::open(['route' => ['biller.employee_appraisals.update', $appraisal->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'put', 'id' => 'edit-employee_appraisals']) }}
