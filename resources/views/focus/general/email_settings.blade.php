                                ...
                                <div class="card-body">
                                    ...
                                    <div class='row mb-1' id="mail_config"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class='form-group'>
                                                {{ Form::label( 'payslip_email_to', 'For Payslip Contact Email',['class' => 'col control-label']) }}
                                                <div class='col'>
                                                    {{ Form::email('payslip_email_to', @$smtp['payslip_email_to'], ['class' => 'form-control box-size', 'placeholder' => 'For Payslip Contact Email']) }}
                                                </div>
                                            </div>
                                            <div class='form-group'>
                                                {{ Form::label( 'customer_statement_email_to', 'For Customer Statement Contact Email',['class' => 'col control-label']) }}
                                                <div class='col'>
                                                    {{ Form::email('customer_statement_email_to', @$smtp['customer_statement_email_to'], ['class' => 'form-control box-size', 'placeholder' => 'For Customer Statement Contact Email']) }}
                                                </div>
                                            </div>
                                            @if (auth()->user()->ins == 2)
                                            <div class='form-group'>
                                                {{ Form::label( 'office_number', 'For PME Support',['class' => 'col control-label']) }}
                                                <div class='col'>
                                                    {{ Form::text('office_number', @$smtp['office_number'], ['class' => 'form-control box-size', 'placeholder' => 'For PME Support']) }}
                                                </div>
                                            </div>
                                            @endif
