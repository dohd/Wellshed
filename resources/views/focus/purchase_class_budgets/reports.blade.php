    ...
    <div class="content-wrapper">
        <div class="content-header row mb-1">
            <div class="content-header-left col-6">
                <h2 class=" mb-0">Non-Project Class Budget Reports </h2>
            </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <table id="etc-table" class="table table-striped table-bordered zero-configuration"
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#etc-table').dataTable({
                ...
                language: tableLan,
                ajax: {
                    url: '{{ route("biller.purchase_class_budgets.get-reports") }}',
                    type: 'GET',
                    data: {c_type: 0}
                },
                columns: [
