...
@section ('title', 'Mpesa Configurations Management')

@section('page-header')
    <h1>{{ 'Mpesa Configurations Management' }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ 'Mpesa Configurations Management' }}</h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#mpesa_configs-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.mpesa_configs.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#mpesa_configs-table_wrapper').removeClass('form-inline');
