...
@section('title', 'Edit Mpesa Config')

@section('page-header')
    <h1>
        <small>Edit Mpesa Config</small>
    </h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Edit Mpesa Config</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($mpesaConfig, ['route' => ['biller.mpesa_configs.update', $mpesaConfig], 'class' => 'form-horizontal', 'files' => true, 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-department']) }}
