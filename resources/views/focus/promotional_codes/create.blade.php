...
@section ('title', 'Create Promotional Code')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0"> Create Promotional Code </h4>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    {{ Form::open(['route' => 'biller.promotional-codes.store', 'method' => 'POST', 'id' => 'create-employee-daily-log', 'enctype' => "multipart/form-data"]) }}
