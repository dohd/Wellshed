...
@section('content')
    <div class="content-wrapper">
        <div class="content-header row mb-1">
            <div class="content-header-left col-6">
                <h4 class="content-header-title mb-0">Environmental Tracking for {{ date('F Y') }}</h4>
            </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="content-header row mb-1">
                                    <div class="content-header-left col-6">
                                        <h4 class="content-header-title">{{ date('F Y') }} Environmental Tracking
                                            Calendar</h4>
                                    </div>
                                    <div class="col-6">
                                        <div class="media-body media-right text-right">
                                ...
                                <table class="environmentalTrackingTable" id="environmentalTrackingTable">
                                    {{-- <tbody> --}}
                                    @foreach ($chunk1 as $a)
                                        <tr>
                                            <td colspan="3"
    ...
    @include('focus.environmental_tracking.modal.new')
@endsection
...
@section('after-styles')
    <style>
        ...
        .environmentalTrackingTable {
            border-collapse: collapse;
            margin: 20px auto;

        }

        .environmentalTrackingTable th,
        .environmentalTrackingTable td {
            border: 1px solid black;
            width: 50px;
            height: 50px;
            text-align: center;
    ...
    <script>
        ...
        const Index = {
            ...
            init() {
                ...
                $('#environmentalTrackingTable td').click(Index.getDay);
                Index.drawDataTable();
            },
