                                ...
                                <div class="card-body">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col border-blue-grey border-lighten-5  p-1 font-weight-bold">
                                            <h4 style="color: #0b0b0b">{{$data->customer->company}}</h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-3 border-blue-grey border-lighten-5  p-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col border-blue-grey border-lighten-5  p-1 font-weight-bold">
                                            <h4 style="color: #0b0b0b">{{$data->project->name}}</h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-3 border-blue-grey border-lighten-5  p-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col border-blue-grey border-lighten-5  p-1 font-weight-bold">
                                            <h4 style="color: #0b0b0b">{{$data->res->first_name}} {{$data->res->last_name}}</h4>
                                        </div>
                                    </div>
