    ...
    <div class="content-wrapper">
        <div class="content-header row mb-1">
            <div class="content-header-left col-6">
                <h4 class="content-header-title mb-0">Environmental Tracking</h4>
            </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <table id="environmentalTrackingTable"
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#environmentalTrackingTable').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: tableLan,
                ajax: {
                    url: '{{ route('biller.environmental-tracking-table.get') }}',
                    data: {
        ...
        $('.filter').change( () => {
            $('#environmentalTrackingTable').DataTable().destroy();
            draw_data();
        })
