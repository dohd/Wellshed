...
@section('page-header')
    <h1>Commission Payment Management</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Commission Payment Management</h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#commissions-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.commissions.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#commissions-table_wrapper').removeClass('form-inline');
