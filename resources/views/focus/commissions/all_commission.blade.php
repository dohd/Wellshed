...
@section('title', 'Manage All Commisions')

@section('page-header')
    <h1>{{ 'Manage All Commisions' }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ 'Manage All Commisions' }}</h4>
                                ...
                                <div class="row form-group">
                                    <div class="col-3">
                                        ...
                                        <select id="company" class="form-control"
                                            data-placeholder="Search Tenant">
                                            <option value="">Search Tenant</option>
                                            @foreach ($companies as $tenant)
                                                <option value="{{ $tenant->id }}">{{ $tenant->cname }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-3">

                                        <select id="promotional_code" class="form-control"
                                            data-placeholder="Search PromoCode">
        ...
        const Index = {
            ...
            init() {
                ...
                $('#open-selected').on('click', function() {
                    ...
                    const url = '/commissions/create_commision_pay?ids=' + encodeURIComponent(selectedUUIDs
                        .join(','));
