...
@section('page-header')
    <h1>
        <small>Create Message Template</small>
    </h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Create Message Template</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::open(['route' => 'biller.message_templates.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-department']) }}
    ...
    <script>
        ...
        const Index = {
            ...
            init() {
                ...
                $('#mediaBlocksSelect').select2({allowClear: true}).attr('disabled',true);
