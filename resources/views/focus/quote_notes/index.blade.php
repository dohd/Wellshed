...
@section ('title', 'Quote Note Management')

@section('page-header')
    <h1>{{ 'Quote Note Management' }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ 'Quote Note Management' }}</h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#quote_notes-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.quote_notes.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#quote_notes-table_wrapper').removeClass('form-inline');
