...
@section ('title', 'Appraisal Types Management')

@section('page-header')
    <h1>{{ 'Appraisal Types Management' }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ 'Appraisal Types Management' }}</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <table id="appraisal_types-table"
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#appraisal_types-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.appraisal_types.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#appraisal_types-table_wrapper').removeClass('form-inline');
