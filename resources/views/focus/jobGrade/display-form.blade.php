...
<div>
    ...
    <p style="font-size: 16px" class="mb-2">
        The following salary ranges have been established for each job grade. Please note that the lower limit for each grade cannot exceed the upper limit. <br>
        Job grades that are not in use will have their salary limits set to 0.00, ensuring clarity and accuracy in our job grading system.
    </p>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" readonly name="{{ $i }}a_upper" id="{{ $i }}a_upper" value="{{ $jobGrades[$i.'a_upper'] ?? '0.00' }}" class="form-control" step="0.01" required>
                    </div>

                    <!-- a_lower -->
                    <div class="col-6">
                        <label for="{{ $i }}a_lower">Lower Limit</label>
                        <input type="number" readonly name="{{ $i }}a_lower" id="{{ $i }}a_lower" value="{{ $jobGrades[$i.'a_lower'] ?? '0.00' }}" class="form-control" step="0.01" required>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" readonly name="{{ $i }}b_upper" id="{{ $i }}b_upper" value="{{ $jobGrades[$i.'b_upper'] ?? '0.00' }}" class="form-control" step="0.01" required>
                    </div>

                    <!-- b_lower -->
                    <div class="col-6">
                        <label for="{{ $i }}b_lower">Lower Limit</label>
                        <input type="number" readonly name="{{ $i }}b_lower" id="{{ $i }}b_lower" value="{{ $jobGrades[$i.'b_lower'] ?? '0.00' }}" class="form-control" step="0.01" required>
                    </div>
                </div>
