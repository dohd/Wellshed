...
@section ('title', 'Edit Selling Price Costing')

@section('page-header')
    <h1>
        <small>Edit Selling Price Costing</small>
    </h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Edit Selling Price Costing</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($sell_price, ['route' => ['biller.sell_prices.update', $sell_price], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-department']) }}
    ...
    <script>
        ...
        const Index = {
            ...
            init(){
                ...
                $('#import_request').attr('disabled',true);
