...
@section ('title', 'Customer Complaints Management')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Customer Complaints Management</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <table id="customer_complains-table"
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#customer_complains-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.customer_complains.get") }}',
                    type: 'post'
                },
                columns: [
                    ...
                    {data: 'solver', name: 'solver'},
                    {data: 'issue_description', name: 'issue_description'},
                    {data: 'initial_scale', name: 'initial_scale'},
                    {data: 'current_scale', name: 'current_scale'},
            ...
            $('#customer_complains-table_wrapper').removeClass('form-inline');
