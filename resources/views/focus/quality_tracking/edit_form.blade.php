<div class="row">
    <div class="col-4">
        ...
        <input type="date" id="date" name="date" required class="form-control box-size mb-2" value="{{$data->date}}">
    </div>
</div>
...
<div class="row">
        ...
        <div class="input-group">
            ...
            <select class="custom-select employee" name="employee[]" id="employee" multiple required>
                @foreach ($employees as $employee)
                    <option value="{{ +$employee->id }}" @if($data->employee) {{ in_array($employee->id, json_decode($data->employee)) ? 'selected' : '' }} @endif>
    ...
    <div class="col-12 mb-2">
        ...
        <div class="input-group">
            <div class="input-group-addon"><span class="icon-file-text-o" aria-hidden="true"></span></div>
            <textarea name="incident_desc" id="incident_desc-p0" cols="35" rows="2" class="form-control tinyinput-small"
    ...
    <div class="col-12 mb-2">
        ...
        <div class="input-group">
            <div class="input-group-addon"><span class="icon-file-text-o" aria-hidden="true"></span></div>
            <textarea name="route_course" id="route_course-p0" cols="35" rows="2" class="form-control tinyinput-small"
...
<div class="row">
        ...
        <div class="tab-content px-1 pt-1">
            ...
            <div class="tab-pane active in row" id="tab_data1" aria-labelledby="tab1" role="tabpanel">
                ...
                <div class="col-12 col-lg-10">
                    ...
                    <textarea name="plan" id="plan" class="tinyinput" cols="30" rows="10">{{ $data->plan ?? '' }}</textarea>
                </div>
            ...
            <div class="tab-pane row" id="tab_data2" aria-labelledby="tab2" role="tabpanel">
                ...
                <div class="col-12 col-lg-10">
                    ...
                    <textarea name="do" id="do" class="tinyinput" cols="30" rows="10">{{ $data->do ?? '' }}</textarea>
                </div>
            ...
            <div class="tab-pane row" id="tab_data3" aria-labelledby="tab3" role="tabpanel">
                ...
                <div class="col-12 col-lg-10">
                    ...
                    <textarea name="check" id="check" class="tinyinput" cols="30" rows="10">{{ $data->check ?? '' }}</textarea>
                </div>
            ...
            <div class="tab-pane row" id="tab_data4" aria-labelledby="tab4" role="tabpanel">
                ...
                <div class="col-12 col-lg-10">
                    ...
                    <textarea name="act" id="act" class="tinyinput" cols="30" rows="10">{{ $data->act ?? '' }}</textarea>
                </div>
    ...
    <div class="mt-3 col-12">
        ...
        <div class="col-12 col-lg-10">
            ...
            <div class="input-group">
                <div class="input-group-addon"><span class="icon-file-text-o" aria-hidden="true"></span></div>
                <textarea name="comments" id="comments-p0" cols="35" rows="2" class="form-control tinyinput" placeholder="Coments">{{ $data->comments ?? '' }}</textarea>
            </div>
        </div>
...
<!-- Countermeasure Closeout Section -->
<div class="row">
    <div class="my-3 col-12 col-lg-10" id="countermeasure_section">
        <h2 class="mb-1">Countermeasure Closeout</h2>
        <h5 class="mb-2">
            Document the countermeasures implemented and the closeout details. Ensure all steps are thoroughly completed and verified.
        </h5>
        ...
        <div class="row">
            <div class="col-12 mb-2">
                ...
                <textarea
                        id="countermeasure" name="countermeasure" class="form-control tinyinput-small"
                        placeholder="Describe the specific actions taken to address the root cause and prevent recurrence"
                >
                    {{ $data['countermeasure'] ?? '' }}
                </textarea>
            </div>
            <div class="col-6">
                ...
                <select class="custom-select" name="cm_responsible_person" id="cm_responsible_person">
                    <option value="">Select Person</option>
                    @foreach ($employees as $employee)
                        <option value="{{ +$employee->id }}" @if($data['cm_responsible_person'] == $employee->id) selected @endif>{{ $employee->first_name }} {{ $employee->last_name }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-6">
                <label for="completion_date">Completion Date</label>
                <input type="date" id="completion_date" name="completion_date" class="form-control mb-2" value="{{ $data['completion_date'] ?? '' }}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <textarea
                        name="verification"
                        id="verification"
                        class="form-control tinyinput"
                        rows="3"
                        placeholder="Describe how the countermeasure was verified to be effective, including any tests conducted, observations made, and the outcomes. Mention who verified the countermeasure and any follow-up actions taken."
                >
                    {{ $data['verification'] }}
                </textarea>
            </div>
