...
@section ('title', 'Edit Pretty Cash')

@section('page-header')
    <h1>
        <small>Edit Pretty Cash</small>
    </h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">Edit Pretty Cash</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($petty_cash, ['route' => ['biller.petty_cashs.update', $petty_cash], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-department']) }}
    ...
    <script>
        ...
        const Index = {
            init(){
                ...
                const petty_cash = @json(@$petty_cash);
                if (petty_cash && petty_cash.id) {
                    if (petty_cash.date) $('#date').datepicker('setDate', new Date(petty_cash.date));
                    if (petty_cash.expected_date) $('#expected_date').datepicker('setDate', new Date(petty_cash.expected_date));
                ...
                let stockRowId = @json(count($petty_cash->items));
                let docRowId = stockRowId;
                const docRow = $('#stockTbl tbody tr').html();
                $('#stockTbl tbody tr:lt(1)').remove(); 
                ...
                $('#addDoc').click(function() {
                    ...
                    $('#product_name-' + docRowId).autocomplete(Index.autoComp(docRowId));
                });
                // remove schedule row
