        ...
        <table>
            <tr>
                <td colspan="3" class="myco">
                    @php $image = 'img/company/' . config('core.logo') @endphp
                    <img src="{{ Storage::disk('public')->exists($image)? Storage::disk('public')->url($image) : '' }}" style="object-fit:contain" width="100%">
                </td>
            </tr>
            <tr>
