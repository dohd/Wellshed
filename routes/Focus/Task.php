 ...
 */
    Route::group( ['namespace' => 'project'], function () {
        Route::post('tasks/get_milestone', 'TasksController@get_milestone')->name('tasks.get_milestone');
        Route::post('tasks/get_tasks', 'TasksController@get_tasks')->name('tasks.get_tasks');
