...
return [
    ...
    */
    ...
    'efris' => [
        'base_url' => env('EFRIS_ENV') == 'production'? env('EFRIS_PROD_URL') : env('EFRIS_DEV_URL'),
    ],    
    
    'omniconvo' => [
        'base_url' => env('OMNICONVO_BASE_URL'),
        'token' => env('OMNICONVO_TOKEN'),
    ],

    'digitax' => [
        'cb_url' => env('DIGITAX_CALLBACK_URL'),
        'base_url' => env('DIGITAX_ENV') == 'production'? env('DIGITAX_PROD_URL') : env('DIGITAX_DEV_URL'),
        'api_key' => env('DIGITAX_ENV') == 'production'? env('DIGITAX_PROD_KEY') : env('DIGITAX_DEV_KEY'),
        'debug'  => env('DIGITAX_DEBUG'),
    ],
